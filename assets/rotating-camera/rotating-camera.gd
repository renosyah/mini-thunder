...
export var vertical_inverted :bool = false
...
func _process(delta):
	...
	rotation_degrees.x += (-facing_direction.y if vertical_inverted else facing_direction.y) * vertical_rotation_speed * delta
